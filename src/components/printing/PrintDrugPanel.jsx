...
const KNOWN_FIELDS = ['amphetamine', 'benzodiazepine', 'cocaine', 'cannabinoids', 'marijuana', 'opiates', 'methamphetamine', 'barbiturates', 'phencyclidine'];

export default function PrintDrugPanel({
  report = {},
  rows,
  printMode = "full",
  clinicalHistory,
  ...
  return (
    <PEFAFormalReportShell
      report={report}
      title={first(titleFallback(), report.test_name, report.testName, "DRUG SCREEN")}
      department={first(report.department, "Toxicology / Clinical Laboratory")}
      printMode={printMode}
