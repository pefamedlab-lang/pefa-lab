...
const KNOWN_FIELDS = ['colour', 'consistency', 'occult_blood', 'ova', 'cysts', 'parasites', 'pus_cells', 'rbc', 'culture', 'organism', 'sensitivity'];

export default function PrintStoolMCS({
  report = {},
  rows,
  printMode = "full",
  clinicalHistory,
  ...
  return (
    <PEFAFormalReportShell
      report={report}
      title={first(titleFallback(), report.test_name, report.testName, "STOOL MICROSCOPY, CULTURE & SENSITIVITY")}
      department={first(report.department, "Microbiology / Parasitology")}
      printMode={printMode}
  ...
  function titleFallback() {
    return "STOOL MICROSCOPY, CULTURE & SENSITIVITY";
  }
}
