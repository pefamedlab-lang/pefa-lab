...
const KNOWN_FIELDS = ['culture', 'organism', 'growth', 'gram_stain', 'identification', 'sensitivity', 'comment'];

export default function PrintBloodCulture({
  report = {},
  rows,
  printMode = "full",
  clinicalHistory,
  ...
  return (
    <PEFAFormalReportShell
      report={report}
      title={first(titleFallback(), report.test_name, report.testName, "BLOOD CULTURE")}
