...
const KNOWN_FIELDS = ['parasite_seen', 'parasite_form', 'species', 'density', 'parasite_count', 'remarks', 'method'];

export default function PrintMalariaParasite({
  report = {},
  rows,
  printMode = "full",
  clinicalHistory,
  ...
  return (
    <PEFAFormalReportShell
      report={report}
      title={first(titleFallback(), report.test_name, report.testName, "MALARIA PARASITE (MICROSCOPY)")}
  ...
  function titleFallback() {
    return "MALARIA PARASITE (MICROSCOPY)";
  }
}
