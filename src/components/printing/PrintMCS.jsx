...
const KNOWN_FIELDS = ['specimen', 'microscopy', 'culture', 'organism', 'sensitivity', 'resistance', 'comment'];

export default function PrintMCS({
  report = {},
  rows,
  printMode = "full",
  clinicalHistory,
  ...
  return (
    <PEFAFormalReportShell
      report={report}
      title={first(titleFallback(), report.test_name, report.testName, "MICROSCOPY, CULTURE & SENSITIVITY")}
      department={first(report.department, "Microbiology")}
      printMode={printMode}
  ...
  function titleFallback() {
    return "MICROSCOPY, CULTURE & SENSITIVITY";
  }
}
